...
public class UserService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.kechen.service.UserService"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.kechen.domain.User", false, UserService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.kechen.repository.UserRepository", false, UserService_ESTest_scaffolding.class.getClassLoader()));
  }
